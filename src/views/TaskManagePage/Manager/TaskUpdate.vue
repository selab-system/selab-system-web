        ...
        <div class="release-form-main-content">
          <div class="release-form-main-content-input-title">
            <div class="release-form-main-content-input-title-item">
              <div
                class="release-form-main-content-input-title-item-title name-input"
              >
          ...
          <div class="release-form-main-content-commit">
            <button class="bottom" @click="commitreleaseForm">更新</button>
            <button class="bottom" @click="redirectIndex">返回</button>
          </div>
        </div>
      </div>
    </div>
